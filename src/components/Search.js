...
// WORD COUNT //
// 699 -- if set to atleast 1 occurances
// 505 -- if set to atleast 2 occurances

const Search = () => {

   var wordList = ['aberrant',
      'aberration',
      'abstain',
      'abstruse',
      'adamant',
   ...
   const searchAllWord = event => {

      event.preventDefault();

      alert("Check console");
      console.log("Search All Word - Called");
      ...
      for (var j = 0; j < wlength; j++) {
         ...
         for (var i = 0; i < data.body.length; i++) {
            ...
            if (res.length > 0) {
               ...
               rlength++;
               // uniqueWord++;
               // console.log(wordList[j] + "-" + res.length )
      ...
      <div className="container">
         ...
         <div className="row">
            ...
            <div className="col-md-4">
               ...
               <div className="d-flex flex-row-reverse input-group mt-5">
                  <div className="input-group-append">
                     <button className="btn btn-outline-warning rounded-0 rounded-end" onClick={(e) => searchAllWord(e)}>Show Word List</button>
                  </div>
               </div>
            </div>
